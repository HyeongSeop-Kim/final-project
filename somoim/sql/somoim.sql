...
CREATE TABLE MOIM (
	   MOIM_ID NUMBER
	 , MOIM_TITLE VARCHAR2(20)			CONSTRAINT NN_MOIM_MOIM_TILTE NOT NULL
	 , MOIM_INFO VARCHAR2(200)
...
CREATE TABLE MEMBERS (
	 ...
	 , ID VARCHAR2(15)					CONSTRAINT NN_MEMBERS_ID NOT NULL
	 ...
	 , BOOKMARCK VARCHAR2(50)
	 , INFO_IMAGE_PATH VARCHARH2(500)
...
CREATE TABLE IMAGE_UPLOAD (
	 ...
	 , MOIM_ID NUMBER			CONSTRAINT NN_IMAGE_UPLOAD_MOIM_ID NOT NULL
	 , MEMBER_ID NUMBER			CONSTRAINT NN_IMAGE_UPLOAD_MEMBER_ID NOT NULL
	 , CONSTRAINT PK_IMAGE_UPLOAD_IMAGE_ID PRIMARY KEY(IMAGE_ID)
	 , CONSTRAINT FK_IMAGE_UPLOAD_MOIM_ID FOREIGN KEY(MOIM_ID) REFERENCES MOIM(MOIM_ID)
	 , CONSTRAINT FK_IMAGE_UPLOAD_MEMBER_ID FOREIGN KEY(MEMBER_ID) REFERENCES MEMBERS(MEMBER_ID)
);

-- 정모 테이블 생성
CREATE TABLE MEETINGS (
	   MEETING_ID NUMBER
	 , MEETING_TITLE VARCHAR2(20)	CONSTRAINT NN_MEETINGS_MEETING_TITLE NOT NULL
	 , MEETING_DATE DATE 			DEFAULT(SYSDATE)
	 , MEETING_PLACE VARCHAR2(20)	CONSTRAINT NN_MEETINGS_MEETING_PLACE NOT NULL
...
CREATE TABLE BOARDS (
	   BOARD_ID NUMBER
	 , BOARD_TITLE VARCHAR2(20)		CONSTRAINT NN_BOARDS_BOARD_TITLE NOT NULL
	 , CONTENT VARCHAR2(2000)
	 , CREATE_DATE DATE 			DEFAULT(SYSDATE)
	 , "LIKE" NUMBER 				DEFAULT(0)
	 , MOIM_ID NUMBER				CONSTRAINT NN_BOARDS_MOIM_ID NOT NULL
	 , MEMBER_ID NUMBER				CONSTRAINT NN_BOARDS_MEMBER_ID NOT NULL
...
CREATE TABLE PARTICIPANTS (
	   MEMBER_ID NUMBER		CONSTRAINT NN_PARTICIPANT_MEMBER_ID NOT NULL
	 , MOIM_ID NUMBER
	 , MEETING_ID NUMBER
	 , JOB_ID NUMBER		CONSTRAINT NN_PARTICIPANT_JOB_ID NOT NULL
	 , CONSTRAINT FK_PARTICIPANTS_MEMBER_ID FOREIGN KEY(MEMBER_ID) REFERENCES MEMBERS(MEMBER_ID)
	 , CONSTRAINT FK_PARTICIPANTS_MOIM_ID FOREIGN KEY(MOIM_ID) REFERENCES MOIM(MOIM_ID)
	 , CONSTRAINT FK_PARTICIPANTS_MEETING_ID FOREIGN KEY(MEETING_ID) REFERENCES MEETINGS(MEETING_ID)
	 , CONSTRAINT FK_PARTICIPANTS_JOB_ID FOREIGN KEY(JOB_ID) REFERENCES JOBS(JOB_ID)
);
