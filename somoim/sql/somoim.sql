...
CREATE TABLE MEETINGS (
	 ...
	 , MEETING_PLACE VARCHAR2(40)	CONSTRAINT NN_MEETINGS_MEETING_PLACE NOT NULL
...
CREATE TABLE MOIM_PARTICIPANTS (
	   MEMBER_ID NUMBER		CONSTRAINT NN_MOIM_PARTICIPANTS_MEMBER_ID NOT NULL
...
CREATE TABLE MEETINGS_PARTICIPANTS (
	 ...
	 , MEMBER_ID NUMBER		CONSTRAINT NN_MEETINGS_PARTICIPANTS_MEMBER_ID NOT NULL
