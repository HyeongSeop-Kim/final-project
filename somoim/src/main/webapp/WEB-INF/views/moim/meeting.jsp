...
<body>
	...
	<header class="p-6">
		<div class="img-box" onclick="coverImageSelect();">
			<img class="img-box-size-1 bora-20 shadow-sm bc-wh"
				src="${meetingimg}/meetingimg1.jpg" /> <input class="ImgSelect"
				type="file" name="uploadImg" value="이미지 선택" />
		</div>
		<div class="margin-bottom-20 flex-box margin-left-223">
			...
			<div class="flex-box margin-left-160">
				<div class="margin-10 margin-top-20 font-s-30">${somoimDatas.moimTitle}</div>
			...
			<nav class="navbar navbar-expand-lg navbar-light"
				...
				<div class="container-fluid">
					<ul class="navbar-nav me-auto">
						<li class="nav-item"><a class="nav-link">모임</a></li>
						<li class="nav-item"><a class="nav-link">게시판</a></li>
						<li class="nav-item"><a class="nav-link">사진첩</a></li>
		...
		<section class="flex-box pt-3 px-0 p-3">
			<div class="col-md-3 bc-wh shadow-sm">
				...
				<div class="p-4 rounded-3 shadow-sm bg-white scroll"
					...
					<div class="margin-10">
						<div class="center p-6">${somoimDatas.moimInfo}</div>
					</div>
				</div>
			</div>
			<!--모임게시판 박스-->
